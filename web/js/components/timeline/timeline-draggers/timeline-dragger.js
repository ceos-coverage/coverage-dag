...
class Dragger extends PureComponent {
  ...
  */
  handleDragDragger = (e, d) => {
    //console.log('handleDragDragger3');
    ...
    if (isDraggerLeftOfAxisBuffer || isDraggerRightOfAxisBuffer) {
      handleDragDragger(e, d);
      //console.log('handleDragDragger1');
    }
    ...
    handleDragDragger(e, d);
    //console.log('handleDragDragger1');
    console.log('Year: '+document.getElementById('year-timeline').value);
    console.log('Year: '+document.getElementById('year-timeline').value);

    var months={'JAN':'01','FEB':'02','MAR':'03','APR':'04','MAY':'05','JUN':'06','JUL':'07','AUG':'08','SEP':'09','OCT':'10','NOV':'11','DEC':'12'};
    if (document.getElementById('nino1+2') != null){
      var tmp_url=document.getElementById('nino1+2').src;
      document.getElementById('nino1+2').src='https://cdnjs.cloudflare.com/ajax/libs/galleriffic/2.0.1/css/loader.gif';
      var url = new URL(document.getElementById('nino1+2').src);
      url.searchParams.set('timestamp',document.getElementById('year-timeline').value+'-'+months[document.getElementById('month-timeline').value]+'-'+document.getElementById('day-timeline').value+'T00:00:00Z')
      document.getElementById('nino1+2').src=url.toString();
    }
    if (document.getElementById('nino3') != null){
      var tmp_url=document.getElementById('nino3').src;
      document.getElementById('nino3').src='https://cdnjs.cloudflare.com/ajax/libs/galleriffic/2.0.1/css/loader.gif';
      var url = new URL(tmp_url);
      url.searchParams.set('timestamp',document.getElementById('year-timeline').value+'-'+months[document.getElementById('month-timeline').value]+'-'+document.getElementById('day-timeline').value+'T00:00:00Z')
      document.getElementById('nino3').src=url.toString();
    }
    if (document.getElementById('nino3.4') != null){
      var tmp_url=document.getElementById('nino3.4').src;
      document.getElementById('nino3.4').src='https://cdnjs.cloudflare.com/ajax/libs/galleriffic/2.0.1/css/loader.gif';
      var url = new URL(tmp_url);
      url.searchParams.set('timestamp',document.getElementById('year-timeline').value+'-'+months[document.getElementById('month-timeline').value]+'-'+document.getElementById('day-timeline').value+'T00:00:00Z')
      document.getElementById('nino3.4').src=url.toString();
    }
    if (document.getElementById('nino4') != null){
      var tmp_url=document.getElementById('nino4').src;
      document.getElementById('nino4').src='https://cdnjs.cloudflare.com/ajax/libs/galleriffic/2.0.1/css/loader.gif';
      var url = new URL(tmp_url);
      url.searchParams.set('timestamp',document.getElementById('year-timeline').value+'-'+months[document.getElementById('month-timeline').value]+'-'+document.getElementById('day-timeline').value+'T00:00:00Z')
      document.getElementById('nino4').src=url.toString();
    }

    if (document.getElementById('rect_chart') != null){
      var tmp_url=document.getElementById('rect_chart').src;
      document.getElementById('rect_chart').src='https://cdnjs.cloudflare.com/ajax/libs/galleriffic/2.0.1/css/loader.gif';
      var url = new URL(tmp_url);
      url.searchParams.set('timestamp',document.getElementById('year-timeline').value+'-'+months[document.getElementById('month-timeline').value]+'-'+document.getElementById('day-timeline').value+'T00:00:00Z')
      document.getElementById('rect_chart').src=url.toString();
    }
  ...
  */
  startShowDraggerTime = () => {
    ...
    console.log('startShowDraggerTime');
