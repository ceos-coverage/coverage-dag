  ...
  const renderTooltip = (feature, overlay) => {
    ...
    ReactDOM.render((
      <div className="tooltip-measure tooltip-custom-black tooltip-static">
        {coords.join(', ')}
        <img id="rect_chart" src="http://ec2-3-65-18-201.eu-central-1.compute.amazonaws.com:8080/get_stats?minx=-90&miny=-10&maxx=-80&maxy=0&timestamp=2016-06-09T00:00:00Z"/>
