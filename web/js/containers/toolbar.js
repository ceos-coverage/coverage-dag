...
import NinoZones from './nino-zones';
...
const CUSTOM_MODAL_PROPS = {
  ...
  TOOLBAR_NINO_ZONE: {
    headerText: 'Nino Zones',
    backdrop: false,
    type: 'toolbar',
    modalClassName: 'toolbar-info-modal toolbar-modal',
    bodyComponent: NinoZones,
    wrapClassName: 'toolbar_modal_outer toolbar_modal_outer',
  },
  TOOLBAR_SNAPSHOT: {
...
class toolbarContainer extends Component {
  ...
  renderNinoZoneButton() {
    const {
      faSize,
      openModal,
    } = this.props;
    const buttonId = 'wv-nino-zone-button';
    const labelText = 'Nino Zones';
    ...
    return (
      <Button
        ...
        onClick={() => openModal('TOOLBAR_NINO_ZONE', CUSTOM_MODAL_PROPS.TOOLBAR_NINO_ZONE)}
      >
        {this.renderTooltip(buttonId, labelText)}
        <FontAwesomeIcon icon="map-marked" size={faSize} />
      </Button>
    );
  }

  renderDrawRectangleButton() {
    const { faSize } = this.props;
    const buttonId = 'wv-custom-draw-button';
    const labelText = 'Draw Rectangle';
    const drawRectEvent = 'draw:rectangle';
    ...
    return (
      <Button
        ...
        aria-label={labelText}
        onClick={() => events.trigger(drawRectEvent)}
      >
        {this.renderTooltip(buttonId, labelText)}
        <FontAwesomeIcon icon="vector-square" size={faSize} />
      </Button>
    );
  }
    ...
    return (
      <ErrorBoundary>
        ...
        >
          ...
          {this.renderNinoZoneButton()}
          {this.renderDrawRectangleButton()}
        </ButtonToolbar>
      </ErrorBoundary>
    );
  }
